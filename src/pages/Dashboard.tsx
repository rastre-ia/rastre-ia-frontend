...
import { useNavigate } from "react-router-dom"; // Importa useNavigate do React Router
...
export default function Dashboard() {
  ...
  const navigate = useNavigate(); // Usa o useNavigate do React Router para navegação
  ...
  const handleLogout = () => {
    // Aqui você normalmente limparia o estado de autenticação
    console.log("Saindo");
    navigate("/login"); // Usa o navigate do React Router para navegar até a página de login
  };
